...
public class GenerateNewClassByJavassist {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CtClass ctClass = pool.makeClass("com.lsy.java.test.javassist.Emp");
        ...
        FileOutputStream fos = new FileOutputStream(new File("/Users/lsy/Softwares/bigdata/Emp.class"));
        fos.write(byteArr);
        fos.close();
    }
